...
class UserProfile(models.Model):
    ...
    bio = models.CharField(
        max_length=500, default="No description yet... this user must be shy!")
    ...
    liked_profiles = models.ManyToManyField(
        User, related_name='liked_user', blank=True)
    ignored_profiles = models.ManyToManyField(
        User, related_name='ignored_user', blank=True)
...
class ProfileGreetedByActiveUser(models.Model):
    ...
    greeter = models.ForeignKey(
        UserProfile, related_name='greeter', default='')
...
class Match(models.Model):
    first_user = models.ForeignKey(
        UserProfile, related_name='first', default='')
    second_user = models.ForeignKey(
        UserProfile, related_name='second', default='')
